  ...
  resources: {
    en: {
      translation: {
        ...
        text_information_villefranche6: "Breakfast/ brunch at Welcome hotel",
    ...
    fr: {
      translation: {
        ...
        text_information_villefranche3:
          "Les lieux pour s'amuser et se relaxer que nous recommendons:",
        text_information_villefranche4: "Achill's",
        text_information_villefranche5: "Plage Baia Bella (à Beaulieu-sur-mer)",
        ...
        text_information_hotel_4_deal:
          " Ces tarifs sont valables jusqu’au 1er Mai.",
        ...
        gettingThere3:
          "Enfin, si vous venez en train, il faudra vous arrêter à la gare de Nice-Ville.",
        parking: "Parking",
        parking0:
        ...
        rsvp_car: "Disposerez-vous d'un véhicule ?",
        ...
        rsvp_error_car: "Pas si vite... la question a été oubliée.",
    ...
    ro: {
      translation: {
        ...
        text_schedule2:
          "Va rog să dați clic pe locații pentru a fi redirecționați către site-urile lor.",
        meeting1: "Începe la ora 16",
        meeting2: "Începe la ora 19",
        meeting3: "Începe la ora 12:30 a două zi",
        ...
        Destination2:
          "Clipe de relaxare sub un baldachin la Cannes, plecări cu barcă din portul Villefranche, petreceri la Saint Tropez sau plimbări pe bulevardele din Nisa sunt amintiri petrecute împreună pe care nu le vom uită.",
        Destination3:
        ...
        text_information_hotel_0_address:
          "3 Bd Maréchal Joffre – 06310 Beaulieu-sur-Mer – France",
        text_information_hotel_0_deal_ibis:
          "De la 1 Iulie până pe 3 Iulie, 2 nopți pentru 2 persoane la prețul de 219€",
        text_information_hotel_1_deal_ibis:
          "De la 1 Iulie până pe 4 Iulie, 3 nopți pentru 2 persoane la prețul de 371€",
        text_information_hotel_2_deal_ibis:
          "De la 1 Iulie până pe 5 Iulie, 4 nopți pentru 2 persoane la prețul de 498€",
        text_information_hotel_deal_ibis:
          "Dacă doriți să rezervați, puteți trimite un email la h8234@accor.com și menționați Mariage de Katia et Carol în subiect.",
        text_information_hotel_1_title: "Riviera Marriott Hôtel Cap d’Ail",
        text_information_hotel_1_address: "Le Port - 06 320 Cap d’Ail",
        text_information_hotel_1_address_tip:
          "(2 min walk distance from A'trego)",
        text_information_hotel_1_deal:
          "'Chambre vue montagne', 1 Iulie pentru 2 persoane: 264€",
        text_information_hotel_2_deal:
        ...
        rsvp_title: "Vă așteptăm cu drag să sărbătorim împreună.",
