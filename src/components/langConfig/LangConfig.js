  ...
  resources: {
    en: {
      translation: {
        ...
        Rsvp: "Rsvp",
        About: "About",
        About0: "We are so delighted to finally be able to organise our wedding and to celebrate this special day with you, full of love, kindness, laugh and champagne of course!",
        About1: "We fell in love in London more than 6 years ago, and it is now time to throw the party of our lifetime in the beautiful French Riveira.",
        ...
        text_schedule0: "We live so far away from a lot of you and don’t get to see you nearly as much as we wish we could, so we’d love to spend the whole weekend celebrating with you.",
        text_schedule1: "The programme includes a wedding ceremony in Villefranche’s 16th century Citadel, a wedding dinner and party at Atrego, and finally a wedding brunch the day after on the rooftop of AC Marriott at Farago on the roof.",
        ...
        text_information_villefranche0:"If you want to know more about Villefranche-sur-mer", 
        text_information_villefranche1:"You can check accommodation on Airbnb :",
        text_information_villefranche2:"Accomodation with Airbnb at Villefranche", 
        text_information_hotel:"Beige, the agency helping us organising our event, got us preferred rates available the weekend of our wedding.", 
        ...
        gettingThere0: "Nice Côte d'Azur Airport is the closest airport. We suggest renting a car once you arrive, so you have the chance to explore. Also all the venues are next to each other but a car would be needed to commute from the wedding ceremony (Villefranche) to the restaurant (Cap d’Ail). ",
        gettingThere1: "Car rental at Nice airport",
        gettingThere2: "If you don’t have the possibility to rent a car, let us know so we can plan ahead.",
